...
public class Message {
    ...
    /**
     * The id for the user who has posted this message. We will assume that this is
     * provided by the front-end of this
     * application.
     */
    @Column(name = "postedBy")
    private Integer postedBy;
    /**
     * The text for this message- eg "this is my first post!". Must be not blank and
     * under 255 characters
     */
    @Column(name = "messageText")
    private String messageText;
    /**
     * The epoch time when this tweet was posted (number of seconds since Jan 1,
     * 1970). Longs are large enough
     * to store this number. We will assume that this number is provided by the
    ...
    /**
     * When posting a new message, the id can be generated by the database. In that
    ...
    /**
     * Whem retrieving a message from the database, all fields will be needed. In
